      ...
      {/* Product details */}
        ...
        <div className='mt-20'>
          ...
          <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500 border-gray-300'>
              <p> An elegant and stylish product designed for modern living. it serves as a perfect addition to any home, combining functionality with aesthetic appeal. </p>
              <p> Crafted with high-quality materials, this product is built to last and withstand daily use. Its sleek design and attention to detail make it a standout piece in any setting. </p>
          </div>  
        </div>
