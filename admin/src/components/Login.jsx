        ...
        <div className='bg-white shadow-md rounded-lg px-8 py-6 max-w-md'>
            ...
            <form onSubmit={onSubmitHandler}>
                <div className='mb-3 min-w-72'>
                    <p className='text-gray-700 font-medium mb-2 text-sm' >Email address</p>
                ...
                <button className=' w-full bg-black text-white px-4 py-2 rounded-md mt-2' type="submit">Login</button>
            </form>
        </div>
    </div>
  )
